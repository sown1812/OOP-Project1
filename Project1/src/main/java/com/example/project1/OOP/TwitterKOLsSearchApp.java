...
public class TwitterKOLsSearchApp extends Application {
    ...
    private void loadKOLData() {
        kolData.clear();
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Administrator\\IdeaProjects\\Project1\\src\\main\\java\\com\\example\\project1\\OOP\\KOL.txt"))) {
            String line;
            int ranking = 1;
