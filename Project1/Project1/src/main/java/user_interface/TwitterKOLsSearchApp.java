...
public class TwitterKOLsSearchApp extends Application {
    ...
    private void loadKOLData() {
        kolData.clear();
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Administrator\\IdeaProjects\\Project1\\src\\main\\resources\\KOL.txt"))) {
            String line;
            int ranking = 1;
    ...
    private void resetAndWriteKeywordToFile(String keywords) {
        try (PrintWriter writer = new PrintWriter(new FileWriter("C:\\Users\\Administrator\\IdeaProjects\\Project1\\src\\main\\resources\\hastag.txt", false))) {
